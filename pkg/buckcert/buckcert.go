...
type Config struct {
	...
	CaURL           string `env:"LETSENCRYPT_CA_URL" default:"https://acme-staging-v02.api.letsencrypt.org/directory" help:"Let's Encrypt CA URL to use."`
	KeyType         string `env:"LETSENCRYPT_KEY_TYPE" default:"P256" help:"Let's Encrypt key type to use."`
	PushPrivateKey  bool   `env:"LETSENCRYPT_PUSH_PRIVATE_KEY" default:"true" help:"Push the private key to the S3 bucket."`
	ChallengeBucket string `env:"LETSENCRYPT_BUCKET" help:"S3 bucket to use to store the challenges."`
}
